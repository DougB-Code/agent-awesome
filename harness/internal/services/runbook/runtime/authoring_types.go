// This file defines DTOs used by runbook authoring APIs.
package runtime
...
// DraftRequest carries a runbook draft create or update payload.
...
// CompileResult contains a compiled runbook definition and YAML body.
...
// RunbookExplanationArtifact stores a concise deterministic design explanation.
type RunbookExplanationArtifact struct {
...
// RunSetupRequest carries a reusable runbook run setup create or update payload.
...
// RunQuery selects runbook runs for the operations screen.
...
// RunSetupQuery selects reusable runbook run setups for launchpad.
