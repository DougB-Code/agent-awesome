// This file implements deterministic Operation input resolution.
package resolution
...
// NewResolver creates an Operation input resolver.
...
func (r Resolver) Resolve(ctx context.Context, req Request) (Result, error) {
	...
	r.applySource(&result, SourceOperationDefault, req.OperationDefaults, req.AllowOverrides)
	r.applySource(&result, SourceCodebaseDefault, req.CodebaseDefaults, req.AllowOverrides)
	r.applySource(&result, SourceWorkflowDefault, req.WorkflowDefaults, req.AllowOverrides)
