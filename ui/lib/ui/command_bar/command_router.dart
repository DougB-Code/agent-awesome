...
class CommandRouter {
  ...
  CommandRoute? _navigationRoute(String text) {
    ...
    const sections = <String, String>{
      ...
      'automation': AppSections.automationOperations,
      ...
      'task': AppSections.automationTasks,
      'tasks': AppSections.automationTasks,
      'task_graph': AppSections.automationTasks,
      'task graph': AppSections.automationTasks,
      'task graphs': AppSections.automationTasks,
